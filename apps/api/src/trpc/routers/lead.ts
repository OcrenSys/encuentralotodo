...
export const leadRouter = router({
  captureWhatsappClick: publicProcedure
    .input(createLeadFromWhatsappClickInputSchema)
    .mutation(({ ctx, input }) => {
      return ctx.leadService.createLeadFromWhatsappClick(input);
    }),
  captureCallClick: publicProcedure
    .input(createLeadFromCallClickInputSchema)
    .mutation(({ ctx, input }) => {
      return ctx.leadService.createLeadFromCallClick(input);
    }),
  captureContactClick: publicProcedure
    .input(createLeadFromContactClickInputSchema)
    .mutation(({ ctx, input }) => {
      return ctx.leadService.createLeadFromContactClick(input);
    }),
  capturePromotionClick: publicProcedure
    .input(createLeadFromPromotionClickInputSchema)
    .mutation(({ ctx, input }) => {
      return ctx.leadService.createLeadFromPromotionClick(input);
    }),
  captureProductClick: publicProcedure
    .input(createLeadFromProductClickInputSchema)
    .mutation(({ ctx, input }) => {
  ...
  updateNotes: protectedProcedure
    .input(updateLeadNotesInputSchema)
    .mutation(({ ctx, input }) => {
