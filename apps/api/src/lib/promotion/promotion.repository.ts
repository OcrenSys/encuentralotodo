...
export interface PromotionRepositoryPort {
  ...
  findByIdWithBusiness(
    promotionId: string,
  ): Promise<RepositoryPromotionWithBusinessRecord | null>;
  create(input: CreatePromotionInput): Promise<RepositoryPromotionRecord>;
  update(
    promotionId: string,
    input: Omit<UpdatePromotionInput, 'promotionId'>,
  ): Promise<RepositoryPromotionRecord | null>;
...
function mapPromotionWithBusinessRecord(
  record: any,
