...
export const createBusinessForOwnerInputSchema =
  businessCreateBaseSchema.extend({
    ...
    if (value.type === 'configurable') {
      if (value.price !== undefined) {
        ctx.addIssue({
          ...
          message:
            'Los productos configurables no usan un precio fijo todavía.',
          path: ['price'],
        });
      }
...
export const listManagedProductsInputSchema =
  managementPaginationInputSchema.extend({
  ...
  .superRefine((values, ctx) => {
    ...
    if (values.originalPrice < values.promoPrice) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message:
          'El precio original debe ser mayor o igual al precio promocional.',
        path: ['originalPrice'],
      });
    }
  });
...
export const updatePromotionInputSchema = z
  ...
  .superRefine((values, ctx) => {
    ...
    if (
      typeof values.promoPrice === 'number' &&
      typeof values.originalPrice === 'number' &&
      values.originalPrice < values.promoPrice
    ) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message:
...
export const listManagedBusinessesInputSchema =
  managementPaginationInputSchema.extend({
    category: businessCategorySchema
      .or(z.literal('ALL'))
      .optional()
...
export const listPlatformUsersInputSchema =
  managementPaginationInputSchema.extend({
...
export type CreateBusinessForOwnerInput = z.infer<
  typeof createBusinessForOwnerInputSchema
>;
...
export type GetBusinessAnalyticsInput = z.infer<
  typeof getBusinessAnalyticsInputSchema
>;
export type GetPlatformAnalyticsInput = z.infer<
  typeof getPlatformAnalyticsInputSchema
>;
...
export type ListManagedProductsInput = z.infer<
  typeof listManagedProductsInputSchema
>;
export type ImportManagedProductDraft = z.infer<
  typeof importManagedProductDraftSchema
>;
export type ImportManagedProductRowInput = z.infer<
  typeof importManagedProductRowInputSchema
>;
export type ImportManagedProductsInput = z.infer<
  typeof importManagedProductsInputSchema
>;
...
export type ListBusinessLeadsInput = z.infer<
  typeof listBusinessLeadsInputSchema
>;
export type LeadCaptureMetadata = z.infer<typeof leadCaptureMetadataSchema>;
export type CreateLeadFromWhatsappClickInput = z.infer<
  typeof createLeadFromWhatsappClickInputSchema
>;
export type CreateLeadFromCallClickInput = z.infer<
  typeof createLeadFromCallClickInputSchema
>;
export type CreateLeadFromContactClickInput = z.infer<
  typeof createLeadFromContactClickInputSchema
>;
export type CreateLeadFromPromotionClickInput = z.infer<
  typeof createLeadFromPromotionClickInputSchema
>;
export type CreateLeadFromProductClickInput = z.infer<
  typeof createLeadFromProductClickInputSchema
>;
...
export type UpdatePlatformUserRoleInput = z.infer<
  typeof updatePlatformUserRoleInputSchema
>;
export type SetPlatformUserActiveInput = z.infer<
  typeof setPlatformUserActiveInputSchema
>;
export type GetUserByIdInput = z.infer<typeof getUserByIdInputSchema>;
export type SelfProfileUpdateInput = z.infer<
  typeof selfProfileUpdateInputSchema
>;
export type AdminUserProfileUpdateInput = z.infer<
  typeof adminUserProfileUpdateInputSchema
>;
export type UpdateBaseUserRoleInput = z.infer<
  typeof updateBaseUserRoleInputSchema
>;
export type AssignUserBusinessRoleInput = z.infer<
  typeof assignUserBusinessRoleInputSchema
>;
export type RemoveUserBusinessRoleInput = z.infer<
  typeof removeUserBusinessRoleInputSchema
>;
export type TransferBusinessOwnershipInput = z.infer<
  typeof transferBusinessOwnershipInputSchema
>;
export type RemoveOwnBusinessRoleInput = z.infer<
  typeof removeOwnBusinessRoleInputSchema
>;
export type ListManagedBusinessesInput = z.infer<
  typeof listManagedBusinessesInputSchema
>;
export type SearchBusinessUsersInput = z.infer<
  typeof searchBusinessUsersInputSchema
>;
export type ListPlatformUsersInput = z.infer<
  typeof listPlatformUsersInputSchema
>;
export type SearchPlatformUsersInput = z.infer<
  typeof searchPlatformUsersInputSchema
>;
