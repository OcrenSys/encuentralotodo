...
const businesses: SeedBusiness[] = [
  {
    ...
    description:
      'Tienda de conveniencia con basicos de despensa seleccionados, kits de reposicion para oficina y entrega rapida por WhatsApp en toda la Zona Norte.',
  ...
  },
  {
    ...
    name: 'Sabor Urbano',
    description:
      'Cocina casual enfocada en bowls de almuerzo, wraps y entregas corporativas reservadas directamente por WhatsApp.',
    category: 'RESTAURANT',
    lat: 18.4702,
    lng: -69.9078,
    zone: 'Naco',
  ...
  },
  {
    ...
    description:
      'Estudio boutique de entrenamiento con clases funcionales, complementos de nutricion y paquetes de bienestar corporativo.',
    category: 'SERVICE',
    lat: 18.4745,
    lng: -69.8881,
    zone: 'Piantini',
  ...
  },
  {
    ...
    name: 'Cafe Ruta 12',
    description:
      'Cafe urbano con bandejas de brunch, suscripciones de desayuno para oficinas y catering para reuniones de ultima hora.',
    category: 'RESTAURANT',
    lat: 18.4669,
    lng: -69.9423,
  ...
  },
  {
    ...
    name: 'Impresos Aura',
    description:
      'Estudio agil de diseno e impresion para menus, kits de marca, stickers y rotulacion comercial.',
    category: 'SERVICE',
    lat: 18.4623,
    lng: -69.9145,
    zone: 'Gazcue',
  ...
  },
  {
    ...
    description:
      'Mercado compacto para la Zona Colonial con canastas listas para llevar, bebidas y kits para estadias cortas.',
    category: 'GENERAL_STORE',
    lat: 18.4717,
    lng: -69.8859,
    zone: 'Zona Colonial',
    ...
    profileImage:
      'https://images.unsplash.com/photo-1488459716781-31db52582fe9?auto=format&fit=crop&w=300&q=80',
    bannerImage:
  ...
  },
  {
    ...
    description:
      'Operador de servicios tecnicos a domicilio para electrodomesticos, mantenimiento de HVAC y visitas preventivas.',
    category: 'SERVICE',
    lat: 18.4567,
    lng: -69.9524,
    zone: 'Bella Vista',
  ...
  },
  {
    ...
    description:
      'Cocina de produccion para planes semanales de almuerzo de oficina, bandejas ejecutivas y cuentas recurrentes de catering.',
    category: 'RESTAURANT',
    lat: 18.4431,
    lng: -69.9642,
    zone: 'Mirador Sur',
  ...
  },
  {
    ...
    name: 'Verde Rapido',
    description:
      'Mercado saludable de conveniencia con ensaladas, jugos y reposiciones rapidas de despensa para oficinas cercanas.',
    category: 'GENERAL_STORE',
    lat: 18.4684,
    lng: -69.9169,
...
const products: SeedProduct[] = [
  {
    ...
    description:
      'Combo semanal de desayuno con cereal, granola y leche de larga duracion para cocinas de oficina.',
    images: [
  ...
  },
  {
    ...
    description:
      'Reposicion practica con detergente, desinfectante, guantes y limpiador de superficies para equipos pequenos.',
    images: [
  ...
  },
  {
    ...
    description:
      'Reposicion surtida para rincones de cafe con porciones dulces y saladas para oficinas medianas.',
    images: [
  ...
  },
  {
    ...
    description:
      'Bowl de arroz con proteina a la parrilla, vegetales asados y salsa de la casa para horas pico de almuerzo.',
    images: [
  ...
  },
  {
    ...
    description:
      'Wrap fresco con pollo sazonado, lechuga y aderezo de cilantro.',
    images: [
  ...
  },
  {
    ...
    description:
      'Combo de alto volumen con bowl, bebida y postre para pedidos corporativos.',
    images: [
  ...
  },
  {
    ...
    description:
      'Paquete mensual configurable de bienestar para equipos pequenos y grupos de liderazgo.',
    images: [
      'https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&w=800&q=80',
    ],
    type: 'configurable',
    configurationSummary:
      'Incluye evaluacion inicial, cupos para clases, consultorias de nutricion y resumen de participacion.',
    isFeatured: false,
  ...
  },
  {
    ...
    description:
      'Surtido de pasteles, cafe y vasos de fruta para reuniones matutinas.',
    images: [
  ...
  },
  {
    ...
    description:
      'Croissants dulces y salados empacados para desayunos de equipo.',
    images: [
  ...
  },
  {
    ...
    description:
      'Servicio recurrente de cafe para oficinas que necesitan apoyo continuo de cafe preparado.',
    images: [
      'https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=800&q=80',
    ],
    type: 'configurable',
    configurationSummary:
      'Elige dias de servicio, tamano de cafetera, extras de pasteleria y franjas de apoyo con barista.',
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      'Lote de stickers laminados para empaques, etiquetas y material de mostrador.',
    images: [
  ...
  },
  {
    ...
    description:
      'Paquete inicial configurable para nuevos negocios que necesitan material coherente de marca.',
    images: [
      'https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=800&q=80',
    ],
    type: 'configurable',
    configurationSummary:
      'Actualizacion de logo, un arte de rotulacion, hoja de stickers y adaptacion de menu o volante.',
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      'Canasta de bienvenida con snacks, bebidas y esenciales rapidos para estadias cortas.',
    images: [
  ...
  },
  {
    ...
    description:
      'Bandeja corporativa balanceada con montaje para reuniones de directorio.',
    images: [
  ...
  },
  {
    ...
    description:
      'Plan recurrente configurable para equipos que necesitan menus semanales y franjas de entrega.',
    images: [
      'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80',
    ],
    type: 'configurable',
    configurationSummary:
      'Rotacion semanal personalizada, preferencias alimentarias, dias de servicio y notas de distribucion.',
    isFeatured: true,
    createdAt: daysAgo(112),
  ...
  },
  {
    ...
    description:
      'Paquete fresco de ensaladas para almuerzos rapidos con aderezo y toppings incluidos.',
    images: [
      'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=800&q=80',
    ],
    type: 'simple',
  ...
  },
  {
    ...
    description:
      'Set de dos botellas de jugo para retiro el mismo dia o entrega en oficina.',
    images: [
...
const promotions: SeedPromotion[] = [
  {
    ...
    description:
      'Combo con descuento para reposiciones de despensa de oficina pedidas antes de las 2 PM.',
    type: 'DISCOUNT',
    status: 'ACTIVE',
    promoPrice: 24.9,
    originalPrice: 31.5,
  ...
  },
  {
    ...
    description:
      'Campana vencida usada para reactivar cuentas recurrentes de snacks para oficina.',
    type: 'ANNOUNCEMENT',
    status: 'EXPIRED',
    promoPrice: 29,
    originalPrice: 36,
  ...
  },
  {
    ...
    description:
      'Combo de almuerzo activo para pedidos de oficina entre semana de 11 AM a 2 PM.',
    type: 'DISCOUNT',
    status: 'ACTIVE',
    promoPrice: 10.5,
    originalPrice: 13.9,
  ...
  },
  {
    ...
    description:
      'Anuncio en borrador preparado para sesiones de degustacion con oficinas pequenas.',
    type: 'ANNOUNCEMENT',
    status: 'DRAFT',
    promoPrice: 0,
    originalPrice: 0,
  ...
  },
  {
    ...
    description:
      'Evento para nuevos clientes con evaluacion inicial y entrada guiada a clases.',
    type: 'EVENT',
    status: 'ACTIVE',
    promoPrice: 19,
    originalPrice: 28,
  ...
  },
  {
    ...
    description:
      'Entrega de desayuno seleccionada para equipos que reservan reuniones recurrentes.',
    type: 'ANNOUNCEMENT',
    status: 'ACTIVE',
    promoPrice: 26,
    originalPrice: 34,
  ...
  },
  {
    ...
    description:
      'Campana vencida de corta duracion para rediseno de menus y produccion de stickers comerciales.',
    type: 'DISCOUNT',
    status: 'EXPIRED',
    promoPrice: 59,
    originalPrice: 82,
  ...
  },
  {
    ...
    description:
      'Precios de lanzamiento para compradores primerizos de bandejas de almuerzo para oficina.',
    type: 'EVENT',
    status: 'ACTIVE',
    promoPrice: 89,
    originalPrice: 115,
  ...
  },
  {
    ...
    description:
      'Campana en borrador para un catalogo ligero mientras el negocio en prueba gratuita valida la demanda.',
    type: 'DISCOUNT',
    status: 'DRAFT',
    promoPrice: 8.5,
    originalPrice: 11,
  ...
  },
  {
    ...
    description:
      'Comunicacion en borrador para atraer hoteles boutique y anfitriones de estadias cortas antes de la aprobacion.',
    type: 'ANNOUNCEMENT',
    status: 'DRAFT',
    promoPrice: 0,
    originalPrice: 0,
...
const leads: SeedLead[] = [
  {
    ...
    status: 'NEW',
    summary:
      'Solicito precios para reposicion de despensa y entrega el mismo dia para una oficina de 12 personas.',
  ...
  },
  {
    ...
    status: 'CONTACTED',
    summary:
      'Necesita un combo recurrente de limpieza y snacks para un piso de coworking.',
  ...
  },
  {
    ...
    status: 'QUALIFIED',
    summary:
      'Pidio una cotizacion para reposiciones semanales de despensa para reuniones en dos sucursales.',
    createdAt: daysAgo(2),
  ...
  },
  {
    ...
    status: 'CLOSED',
    summary:
      'Se convirtio en un pequeno contrato mensual de despensa tras una prueba de dos semanas.',
    createdAt: daysAgo(7),
    updatedAt: daysAgo(1),
  },
  {
    ...
    status: 'QUALIFIED',
    summary:
      'Solicito rotacion de menu y precios para un equipo de 25 personas.',
    createdAt: daysAgo(1),
    updatedAt: hoursAgo(10),
  },
  {
    ...
    status: 'NEW',
    summary:
      'Pregunto si el combo ejecutivo aplica para pedidos semanales recurrentes.',
  ...
  },
  {
    ...
    status: 'CONTACTED',
    summary:
      'Necesita opciones vegetarianas y sin gluten para el almuerzo del equipo todos los viernes.',
    createdAt: daysAgo(3),
    updatedAt: daysAgo(1),
  },
  {
    ...
    status: 'NEW',
    summary:
      'Interesada en un paquete de bienestar para una startup remota que visita la oficina dos veces por semana.',
  ...
  },
  {
    ...
    status: 'QUALIFIED',
    summary:
      'Pidio precios para un programa funcional de 3 meses para cohortes de liderazgo.',
    createdAt: daysAgo(4),
    updatedAt: hoursAgo(18),
  },
  {
    ...
    status: 'CONTACTED',
    summary:
      'Solicito bandejas recurrentes de desayuno para sesiones de planificacion de los martes.',
    createdAt: daysAgo(2),
    updatedAt: hoursAgo(21),
  },
  {
    ...
    status: 'NEW',
    summary:
      'Pregunto si el precio de lanzamiento puede cubrir bandejas vegetarianas y altas en proteina.',
  ...
  },
  {
    ...
    status: 'CONTACTED',
    summary:
      'Necesita entrega semanal de almuerzo para una oficina legal con asistencia rotativa.',
    createdAt: daysAgo(3),
    updatedAt: hoursAgo(16),
  },
  {
    ...
    status: 'CLOSED',
    summary:
      'Cerro un piloto recurrente de almuerzos por 4 semanas tras una sesion de degustacion exitosa.',
    createdAt: daysAgo(9),
    updatedAt: daysAgo(2),
  },
  {
    ...
    status: 'NEW',
    summary:
      'Interesada en alternativas de despensa enfocadas en salud para el equipo de una agencia boutique.',
...
const reviews: SeedReview[] = [
  {
    ...
    rating: 5,
    comment:
      'La entrega fue rapida y el combo de despensa fue exactamente lo que nuestra oficina necesitaba.',
  ...
  },
  {
    ...
    rating: 4,
    comment:
      'Confiable para pedidos recurrentes de snacks, aunque los cambios deberian avisarse con mas anticipacion.',
    createdAt: daysAgo(7),
  },
  {
    ...
    rating: 5,
    comment:
      'El combo ejecutivo llego caliente y los tamanos de las porciones fueron consistentes.',
    createdAt: daysAgo(8),
  },
  {
    ...
    rating: 3,
    comment:
      'Buen sabor, pero una entrega se retraso durante una hora pico de almuerzo.',
    createdAt: daysAgo(4),
  },
  {
    ...
    rating: 5,
    comment:
      'La evaluacion y el seguimiento fueron muy estructurados, no solo una clase de prueba generica.',
    createdAt: daysAgo(6),
  },
  {
    ...
    rating: 4,
    comment:
      'Buena calidad de entrenamiento e instrucciones claras para quienes asistian por primera vez.',
    createdAt: daysAgo(12),
  },
  {
    id: 'review-ruta-ana',
    ...
    rating: 5,
    comment:
      'Las bandejas de desayuno llegaron impecables y a tiempo para nuestra reunion con clientes.',
    createdAt: daysAgo(5),
  },
  {
    ...
    rating: 4,
    comment:
      'Muy buen programa de cafe, aunque me gustaria una opcion adicional de pasteleria en el combo.',
    createdAt: daysAgo(3),
  },
  {
    ...
    rating: 5,
    comment:
      'La entrega de impresion fue rapida y las sugerencias de marca fueron practicas.',
    createdAt: daysAgo(11),
  },
  {
    ...
    rating: 5,
    comment:
      'La entrega recurrente de almuerzos simplifico la operacion de nuestro equipo y el menu se mantuvo variado.',
    createdAt: daysAgo(9),
  },
  {
    ...
    rating: 4,
    comment:
      'Buena calidad y montaje, pero una bandeja vegetariana estuvo poco sazonada.',
    createdAt: daysAgo(2),
  },
  {
    ...
    rating: 4,
    comment:
      'Productos frescos y un catalogo enfocado que funciona bien para snacks saludables de oficina.',
    createdAt: daysAgo(1),
  },
];
...
const auditLogs: SeedAuditLog[] = [
  {
    ...
    metadata: {
      fromRole: 'USER',
      toRole: 'ADMIN',
      reason: 'Cobertura operativa de la plataforma',
    },
  ...
  },
  {
    ...
    metadata: {
      fromActive: true,
      toActive: false,
      reason: 'Cuenta de prueba inactiva conservada para cubrir historial',
    },
    createdAt: daysAgo(5),
  },
  {
  ...
  },
  {
    ...
    metadata: {
      role: 'GERENTE',
      reason: 'Rotacion de personal antes de la aprobacion',
    },
    createdAt: daysAgo(3),
  },
  {
  ...
  },
  {
    ...
    metadata: {
      role: 'GERENTE',
      reason: 'Apoyo de apertura para estudio premium plus',
    },
...
function assertBusinessRelationships() {
  ...
  for (const business of businesses) {
    if (!knownUserKeys.has(business.ownerKey)) {
      throw new Error(
        `El negocio ${business.id} referencia un propietario desconocido ${business.ownerKey}.`,
      );
    }
    ...
    for (const managerKey of business.managerKeys) {
      if (!knownUserKeys.has(managerKey)) {
        throw new Error(
          `El negocio ${business.id} referencia un gerente desconocido ${managerKey}.`,
        );
      }

      if (managerKey === business.ownerKey) {
        throw new Error(
          `El negocio ${business.id} no puede asignar al propietario como gerente.`,
        );
      }

      if (managerSet.has(managerKey)) {
        throw new Error(
          `El negocio ${business.id} repite al gerente ${managerKey}.`,
        );
      }
...
async function seedBusinessMemberships(userIdsByKey: Record<string, string>) {
  ...
  for (const business of businesses) {
    const createdAt = new Date(
      Math.min(business.createdAt.getTime(), business.lastUpdated.getTime()),
    );
  ...
  await prisma.auditLog.createMany({
    data: auditLogs.map((auditLog) => ({
      ...
      targetUserId: auditLog.targetKey
        ? requireUserId(userIdsByKey, auditLog.targetKey)
        : null,
...
async function logSeedSummary(seededCounts: {
  ...
  console.table([
    ...
    {
      entidad: 'identidadesDeUsuario',
      sembrados: seededCounts.identities,
      total: totalIdentities,
    },
    {
      entidad: 'negocios',
      sembrados: seededCounts.businesses,
      total: totalBusinesses,
    },
    {
      entidad: 'rolesUsuarioNegocio',
      sembrados: seededCounts.userBusinessRoles,
      total: totalRoles,
    },
    {
      entidad: 'gerentesDeNegocio',
      sembrados: seededCounts.businessManagers,
      total: totalManagers,
    },
    {
      entidad: 'productos',
      sembrados: seededCounts.products,
      total: totalProducts,
    },
    {
      entidad: 'promociones',
      sembrados: seededCounts.promotions,
      total: totalPromotions,
    },
    { entidad: 'leads', sembrados: seededCounts.leads, total: totalLeads },
    {
      entidad: 'resenas',
      sembrados: seededCounts.reviews,
      total: totalReviews,
    },
    {
      entidad: 'registrosDeAuditoria',
      sembrados: seededCounts.auditLogs,
      total: totalAuditLogs,
    },
  ]);

  console.log('Distribucion por estado de negocio:', {
    APROBADOS: businesses.filter((business) => business.status === 'APPROVED')
      .length,
    PENDIENTES: businesses.filter((business) => business.status === 'PENDING')
      .length,
  });

  console.log('Distribucion por estado de promocion:', {
    ACTIVAS: promotions.filter((promotion) => promotion.status === 'ACTIVE')
      .length,
    BORRADOR: promotions.filter((promotion) => promotion.status === 'DRAFT')
      .length,
    VENCIDAS: promotions.filter((promotion) => promotion.status === 'EXPIRED')
      .length,
  });
}
...
async function main() {
  ...
  const userIdsByKey = mergeUserMaps(
    platformUserIds,
    businessUserIds,
    customerUserIds,
  );
